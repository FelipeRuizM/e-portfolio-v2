...
const data = projects.find(p => p.id === 'e-commerce');
  ...
  return (
    <ProjectLayout project={data}>
      <div className="max-w-3xl text-portfolio-light/70 font-body text-xl md:text-2xl leading-relaxed gap-6 flex flex-col">
         <p>This is a technical deep dive dedicated strictly to outlining the architectural decisions natively bound to deploying the E-commerce platform ecosystem.</p>
